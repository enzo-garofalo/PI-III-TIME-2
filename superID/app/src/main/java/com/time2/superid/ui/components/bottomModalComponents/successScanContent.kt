...
fun successScanContent(
    ...
    Column(
        ...
        Icon(
            ...
            contentDescription = "ícone de escaneamento concluído",
        ...
        Text(
            text = partnerSite?.let { "Autenticação concluída para $it" } ?: "QR Code escaneado com sucesso",
            color = Color.Gray,
            fontSize = 14.sp,
